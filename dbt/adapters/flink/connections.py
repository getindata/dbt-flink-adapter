...
class FlinkConnectionManager(SQLConnectionManager):
    ...
    def show_catalogs(self) -> List[str]:
        return SchemaOperation.show_catalogs(self.current_session())
    ...
    def execute_ddl_wait_done(self, sql: str) -> None:
        SchemaOperation.execute_sql_and_wait_end(self.current_session(), sql)
